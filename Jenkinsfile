        ...
        stage('Unit Test') {
            steps {
                ...
                sh '''
                    ...
                    docker run --rm -v /var/jenkins_home/workspace/WeatherApp:/workspace python:3.11 /bin/bash -c "ls -la /workspace && ls -la /workspace/Tests && python -m unittest discover -s /workspace/Tests -p 'test*.py'"
                '''
            }
        }
