        ...
        stage('Unit Test') {
            steps {
                ...
                sh '''
                    ...
                    docker run --rm -v /var/jenkins_home/workspace/WeatherApp:/workspace python:3.11 /bin/bash -c "ls -l /workspace && ls -l /workspace/Tests && python -m unittest discover -s /workspace/Tests -p 'test*.py'"
                '''
            }
        }
