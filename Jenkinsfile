        ...
        stage('Unit Test') {
            steps {
                ...
                sh '''
                    ...
                    docker run --rm -v /var/jenkins_home/workspace/WeatherApp:/workspace -w /workspace -e PYTHONPATH=/workspace python:3.11 python -m unittest discover -s Tests -p "test*.py"
                '''
            }
        }
